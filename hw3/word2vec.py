...
def bce_loss(probabilities: Tensor, labels: Tensor) -> Tensor:
    ...
    right = ops.multiply(ones - labels, ops.log(ones - probabilities))
    return ops.multiply(minus_one, reduce_mean(left + right))
...
class Word2Vec(nn.Module):
    ...
    def forward(self, target_one_hots: Tensor, context_one_hots: Tensor) -> Tensor:
